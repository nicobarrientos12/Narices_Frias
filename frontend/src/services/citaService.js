...
const API_BASE =
  import.meta.env.VITE_API_CITAS ||
  (import.meta.env.VITE_API_BASE ? `${import.meta.env.VITE_API_BASE}/citas` : 'http://localhost:3001/api/citas');
...
export async function fetchCita(id) {
