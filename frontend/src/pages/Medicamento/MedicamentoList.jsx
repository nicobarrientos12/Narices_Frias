...
export default function MedicamentoList() {
  ...
  const loadData = async () => {
    try {
      ...
      alert(error?.message || 'No se pudieron cargar los medicamentos');
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-extrabold" style={{ color: COLORS.ink }}>Medicamentos</h2>
      ...
      <div className="overflow-x-auto rounded-2xl" style={{ border: `1px solid ${COLORS.line}`, backgroundColor: COLORS.bg }}>
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan="4" className="p-10 text-center">
                  ...
                  <div className="font-bold" style={{ color: COLORS.ink }}>No hay medicamentos registrados</div>
        ...
        <div className="md:hidden divide-y" style={{ borderTop: `1px solid ${COLORS.line}` }}>
          {loading ? (
            <div className="p-6 text-center text-sm" style={{ color: COLORS.inkSoft }}>Cargando medicamentos…</div>
          ) : pageItems.length ? (
            pageItems.map((m) => (
